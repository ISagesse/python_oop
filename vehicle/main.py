# python class Implicit Inheritance
# implicit inheritance which allows us to use inherited attributes and methods of the Vehicle(parent) class in our new subclasses.
